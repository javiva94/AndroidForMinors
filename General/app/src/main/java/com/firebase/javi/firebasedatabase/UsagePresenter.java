...
import static com.firebase.javi.firebasedatabase.UsageStatVH.valor;
...
public class UsagePresenter implements UsageContract.Presenter {
    ...
    public static UsageContract.View view;
    ...
    public void retrieveUsageStats() {
        ...
        Map<String, UsageStats> usageStats = usageStatsManager.queryAndAggregateUsageStats(getStartTime(), getFinishTime());
